\begin{adjustwidth}{0.2cm}{0.2cm}
    ...
    មិនត្រឹមតែភាពខ្វះខាតនៃ ទិន្នន័យ {\englishfont\fontsize{13.5pt}{20pt}\selectfont (dataset)} 
    សម្រាប់ ឲ្យម៉ូដែលរៀនប៉ុណ្ណោះ ទេ ប៉ុន្តែ 
    ...
    ភាពស្មុគស្មាញ ខ្លាំងសម្រាប់ការចាប់យកអក្សរ ចេញពីរូបភាពដែលមានអក្សរលាយលំគ្នាច្រើន
    ភាសាបែបនេះ។
    ...
    អត្ថបទដែលអាចធ្វើការកែប្រែបាន {\englishfont\fontsize{13.5pt}{20pt}\selectfont (text-recognition)}។ 
    ដំណាក់កាលទាំងពីរនេះ គឺបង្កើត
    ឡើងសម្រាប់ធ្វើការដោះស្រាយភាពស្មុគស្មាញទៅលើភាសាខ្មែរ និងការលាយលំភាសាខ្មែរជាមួយ
    នឹងភាសាអង់គ្លេស។
    ...
    data ទាំងអស់នោះដោយខ្លួន ឯង ចំនួន 369 រូបភាព ហើយបានធ្វើការកំណត់ទីតាំងអក្សរ
    នៅលើរូបភាព ទទួលបាន 7552 ទីតាំងផ្សេងគ្នា។
    ...
    {\englishfont\fontsize{13.5pt}{20pt}\selectfont generate} មួយនេះ។ 
    បន្ទាប់មកយើងទទួលបានពីការ {\englishfont\fontsize{13.5pt}{20pt}\selectfont generate} 
    ប្រហែល 7.4 លាន រូបភាព។
    ...
    យើងបាន បង្រៀនម៉ូដែល ទៅលើ dataset manually collected ប្រហែល 369 
    រូបភាព ដែលអាចកំណត់ទីតាំងអក្សរនៅលើរូបភាពបានល្អ។ យើងទទួលបាន 
    {\englishfont\fontsize{13.5pt}{20pt}\selectfont recall 97\%, precision 97\%,} 
    IOU 85\%
    និងចុងក្រោយគឺ {\englishfont\fontsize{13.5pt}{20pt}\selectfont F1-score 97\%} ។ 
