...
\englishfont\fontsize{13.5pt}{17pt}\selectfont 
    ...
    { \hspace{1cm} 2.3.1 CRAFT Evaluation Metrics\dotfill\pageref{subsec:craft-evaluation}\par}
    { \hspace{1cm} 2.3.2 Heatmap Visualization\dotfill\pageref{subsec:headmap_visualization}\par}
    ...
    { \hspace{1cm} 4.3.2 CRAFT Network Architecture\dotfill\par}
    ...
    { \hspace{1cm} 4.4.2 Architecture Overview\dotfill\par}
    ...
    \vspace{0.5cm}
    { \textbf{Chapter 6: Discussion and Future Work}\dotfill\pageref{ch:discussion}\par}
    { \hspace{0.5cm} 6.1 Effectiveness of Synthetic Data\dotfill\pageref{sec:effectiveness}\par}
    { \hspace{0.5cm} 6.2 Strengths and Limitations of the OCR System\dotfill\pageref{sec:strengths}\par}
    { \hspace{0.5cm} 6.3 Research Challenges and Lessons Learned\dotfill\pageref{sec:challenges}\par}
    { \hspace{0.5cm} 6.5 Impact on Khmer NLP and OCR Research\dotfill\pageref{sec:impact}\par}
    ...
    { \hspace{0.5cm} Appendix A: Sample Annotated Images\dotfill\pageref{appendix-a}\par}
    { \hspace{0.5cm} Appendix B: List of Fonts Used\dotfill\pageref{appendix-b}\par}
    { \hspace{0.5cm} Appendix C: Code Snippets and Training Configuration\dotfill\pageref{appendix-c}\par}
    { \hspace{0.5cm} Appendix D: Additional Evaluation Examples\dotfill\pageref{appendix-d}\par}
