...
\begin{figure}[H]
    ...
    \caption{Here is future work, we will improve make it working on Khmer Handwritten text, on street text such as sign or any posters,
    , curve text such as text on logo or public street that is present as curve, and also improve the accuracy of the model.}
