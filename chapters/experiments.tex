...
Fig.\ref{fig:craft-model} shows clearly the CRAFT network architecture. 

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/craft_model_architecture.png}
    \caption{Figure 3. Illustration of ground truth generation procedure in our framework. 
